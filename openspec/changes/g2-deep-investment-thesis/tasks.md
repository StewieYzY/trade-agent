...
- [ ] 3.1 完成并归档 `g2-growth-expectation-contract` child change，冻结输入/输出、用户 assumption snapshot、模型适用性、失败语义和 golden cases
- [ ] 3.2 完成并归档 `g2-growth-expectation-v0-engine` child change，实现 EPV proxy、成熟期估值交叉锚、两种 reverse 求解和敏感性分析
