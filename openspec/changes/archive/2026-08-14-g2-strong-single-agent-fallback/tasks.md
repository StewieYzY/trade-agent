...
- [x] 4.4 验证证据：fallback focused 27 passed；Council preflight/dossier 16 passed；production-path 20 passed；provenance/provider-redaction 53 passed；最终全量 `value-screener/tests` 920 passed；OpenSpec strict 29/29；compileall、diff check 通过
