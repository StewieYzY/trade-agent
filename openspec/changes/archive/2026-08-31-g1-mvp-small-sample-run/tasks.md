...
- [x] 4.3 Archive the child, merge and push to `origin/main`, re-run merged-main validation, then remove only this child branch/worktree.
- [x] 4.4 Record `engineering_status=merged`, `capability_status=not_evidence`, M1.3 pending, and G1 Capability Gate not passed.
